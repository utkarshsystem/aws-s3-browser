...
function S3BrowserComponent(param) {
    let { s3, region = 'us-east-1', onOpenInEditor } = param;
    _s();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$4$2e$5_react$2d$dom$40$19$2e$2$2e$3_react$40$19$2e$2$2e$3_$5f$react$40$19$2e$2$2e$3$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "S3BrowserComponent.useEffect": ()=>{
            ...
            setError(null);
            s3.listBuckets().then({
                "S3BrowserComponent.useEffect": (names)=>setBuckets(names)
    ...
    }["S3BrowserComponent.useCallback[handleCreateFolder]"], [
        currentBucket,
        currentPrefix,
        newFolderName,
        s3,
...
;
;
const region = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$4$2e$5_react$2d$dom$40$19$2e$2$2e$3_react$40$19$2e$2$2e$3_$5f$react$40$19$2e$2$2e$3$2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_AWS_REGION || 'us-east-1';
async function s3Post(action) {
    ...
    var _json_error;
    if (!res.ok) throw new Error((_json_error = json.error) !== null && _json_error !== void 0 ? _json_error : "S3 API error: ".concat(res.status));
    return json;
}
function createS3Operations() {
    return {
        ...
        async uploadFile (bucket, key, file) {
            const res = await fetch("/api/s3/upload?bucket=".concat(encodeURIComponent(bucket), "&key=").concat(encodeURIComponent(key), "&region=").concat(encodeURIComponent(region)), {
                method: 'PUT',
                headers: {
            ...
            if (!res.ok) {
                ...
                var _json_error;
                throw new Error((_json_error = json.error) !== null && _json_error !== void 0 ? _json_error : "Upload failed: ".concat(res.status));
            }
        },
...
function Home() {
    ...
    const s3 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$4$2e$5_react$2d$dom$40$19$2e$2$2e$3_react$40$19$2e$2$2e$3_$5f$react$40$19$2e$2$2e$3$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "Home.useMemo[s3]": ()=>createS3Operations()
    }["Home.useMemo[s3]"], []);
...
_s(Home, "smmBKmJAW/sSP0tRPzr/VsLp33U=", false, function() {
    return [
...
"[project]/node_modules/.pnpm/next@15.4.5_react-dom@19.2.3_react@19.2.3__react@19.2.3/node_modules/next/dist/compiled/react/cjs/react-jsx-dev-runtime.development.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/.pnpm/next@15.4.5_react-dom@19.2.3_react@19.2.3__react@19.2.3/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
    ...
    module.exports = __turbopack_context__.r("[project]/node_modules/.pnpm/next@15.4.5_react-dom@19.2.3_react@19.2.3__react@19.2.3/node_modules/next/dist/compiled/react/cjs/react-jsx-dev-runtime.development.js [app-client] (ecmascript)");
}
}}),
"[project]/node_modules/.pnpm/next@15.4.5_react-dom@19.2.3_react@19.2.3__react@19.2.3/node_modules/next/navigation.js [app-client] (ecmascript)": ((__turbopack_context__) => {

var { m: module, e: exports } = __turbopack_context__;
{
module.exports = __turbopack_context__.r("[project]/node_modules/.pnpm/next@15.4.5_react-dom@19.2.3_react@19.2.3__react@19.2.3/node_modules/next/dist/client/components/navigation.js [app-client] (ecmascript)");
}}),
}]);

//# sourceMappingURL=_50fe937f._.js.map